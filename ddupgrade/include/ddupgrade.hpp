...
class [[eosio::contract("ddupgrade")]] ddupgrade : public contract {
   public:
      ...
      using propose_action = eosio::action_wrapper<"propose"_n, &ddupgrade::propose>;
      using exec_action = eosio::action_wrapper<"exec"_n, &ddupgrade::exec>;
